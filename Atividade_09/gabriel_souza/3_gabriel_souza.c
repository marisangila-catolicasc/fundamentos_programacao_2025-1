...
• A soma de todos os elementos das linhas pares; ok
• O valor do primeiro elemento da matriz e do  ́ultimo; ok
• A soma dos elementos da linha 2; ok
• Mostre somente os elementos da Diagonal Principal;
• O maior valor e sua posi ̧c ̃ao na matriz;
• O menor valor e sua posi ̧c ̃ao na matriz.
*/
