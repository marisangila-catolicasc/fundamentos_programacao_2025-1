#include <stdio.h>
/*
. Fa¸ca um programa que mostre um menu que lista todos os estados brasileiros. Cada
um deve ser representado por um n´umero. Em seguida, mostre na tela qual regi˜ao
o estado se localiza (Norte, Nordeste, Centro-Oeste, Sudeste ou Sul).
*/
int main() {
    int estado;
