...
int main(void) {
    ...
    printf("No Brasil há 26 estados e o Distrito Federal, opções abaixo: \n");
    printf("(1)  Acre\n");
    printf("(2)  Alagoas\n");
    printf("(3)  Amapá\n");
    printf("(4)  Amazonas\n");
    ...
    switch (opcao) {
        case 1: case 3: case 4: case 14: case 22: case 23: case 27:
            printf("Situado na Região Norte\n");
            break;
        case 2: case 5: case 6: case 10: case 15: case 17: case 18: case 20: case 26:
            printf("Situado na Região Nordeste\n");
            break;
        case 7: case 9: case 11: case 12:
            printf("Situado na Região Centro-Oeste\n");
            break;
        case 8: case 13: case 19: case 25:
            printf("Situado na Região Sudeste\n");
            break;
        case 16: case 21: case 24:
            printf("Situado na Região Sul\n");
            break;
        default:
            printf("Opção não existente. Selecione um número de 1 a 27.\n");
    }
